...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?php echo Form::input('area', Input::post('area'), array('class' => 'form-control', 'placeholder' => 'admin')); ?>
        <?php echo Form::error('area', $err); ?>
    </div>
</div>
<div class="form-group">
    <?php echo Form::label(__('menu.perm'), 'perm', array('class' => 'col-sm-2 control-label required')); ?>
    <div class="col-sm-9">
        <?php echo Form::select('perm', Input::post('perm'), $perms, array('id' => 'permission', 'class' => 'form-control',)); ?>
        <?php echo Form::error('perm', $err); ?>
    </div>
</div>

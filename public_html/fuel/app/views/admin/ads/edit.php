<h1 class="page-header"><?= __('ads.edit'); ?></h1>
<?php echo Form::open(array("class"=>"form-horizontal", 'enctype' => 'multipart/form-data')); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <?php echo Html::img(Uri::base().'assets/img/ads_img/'.$img->image_name, array("title" => $img->image_name, "alt" => $img->image_name, "class" => "", "height" => 304, "width" => 230)); ?>
        </div>
    </div>

    <div class="form-group">
        <?php echo Form::label(__('ads.link'), 'link', array('class' => 'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
            <?php echo Form::input('link', Input::post('link', isset($img) ? $img->link : ''), array('class' => 'form-control')); ?>
            <?php echo Form::error('link', $err); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <?php echo Html::anchor('admin/ads', __('common.cancel'), array('class' => 'btn btn-default')); ?>
        </div>
    </div>
<?php echo Form::close(); ?>
